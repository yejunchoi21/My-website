...
<section id="portfolio">
    ...
    <div className="container portfolio__container">
        ...
        <article className="portfolio__item">
            <div className="portfolio__item-image">
                <img src={IMG6} alt="portfolio__item-image" />
            </div>
        ...
        <article className="portfolio__item">
            <div className="portfolio__item-image">
                <img src={IMG5} alt="portfolio__item-image" />
            </div>
                <h3>This is a portfolio item title</h3>
                <a href="https://github.com/yejunchoi21/Bakery-Platform " className="btn" target="_blank">Github</a>
        </article>
    </div>
</section>
  )
